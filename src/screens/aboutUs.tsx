        ...
        <div className="container mx-auto hd_bg rounded-xl">
          <div className="flex justify-between items-center px-4 py-6">
            <div className="flex items-center">
              ...
              <h1 className="text-lg font-bold theme_text" style={{fontSize: '20px'}}>About Us</h1>
            </div>
              ...
              <div className="space-y-6 text-sm md:text-base leading-relaxed">
                <section className="text-center">
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-br from-[#610419] to-[#7a0028] text-white rounded-xl p-6 shadow-lg" style={{background:"linear-gradient(to bottom right, #610419, #7a0028)" }}>
