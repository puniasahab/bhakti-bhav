            ...
            <div className="flex flex-col items-center text-center py-6 pb-10 anim-slide-enter">
              ...
              <div className="w-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-[11px] font-black text-gray-400 tracking-widest uppercase">Humse Judo</span>
                ...
                <div className="flex gap-3">
                  {/* Instagram */}
                  <a
                    href="https://www.instagram.com/bhaktibhavapp?stkn=emltN2Z3Mmk3ZmF4"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-2xl font-black text-sm text-white active:scale-95 transition-all shadow-[0_4px_14px_rgba(225,48,108,0.35)] cursor-pointer"
                  ...
                  {/* YouTube */}
                  <a
                    href="https://m.youtube.com/@Bhaktibhavofficialapp?ra=m"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-2xl font-black text-sm text-white active:scale-95 transition-all shadow-[0_4px_14px_rgba(255,0,0,0.3)] cursor-pointer"
                    style={{ background: "linear-gradient(135deg, #FF0000, #CC0000)" }}
                  >
                    <svg width="22" height="16" viewBox="0 0 24 17" fill="white">
                      <path d="M23.495 2.205a3.02 3.02 0 00-2.122-2.136C19.505 0 12 0 12 0S4.495 0 2.627.07a3.02 3.02 0 00-2.122 2.136C0 4.073 0 8.5 0 8.5s0 4.427.505 6.295A3.02 3.02 0 002.627 16.93C4.495 17 12 17 12 17s7.505 0 9.373-.07a3.02 3.02 0 002.122-2.136C24 12.927 24 8.5 24 8.5s0-4.427-.505-6.295zM9.545 12.068V4.932L15.818 8.5l-6.273 3.568z"/>
                    </svg>
                    <span>YouTube</span>
                  </a>
                </div>
