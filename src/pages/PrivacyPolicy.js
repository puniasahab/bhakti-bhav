        ...
        <>
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl text-gray-800 font-eng">
                ...
                <section className="mb-4">
                    ...
                    <h2 className="text-xl font-semibold mb-2">Usage Data</h2>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">Information Collected while Using the Application</h2>
                    <p className="mb-2">
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                        Sharing may occur with Service Providers, Affiliates, business partners, other users, or with your consent.
                    </p>
                </section>
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold mb-2">Transfer of Your Personal Data</h2>
                    <p className="mb-2">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold mb-2">Delete Your Personal Data</h2>
                    <p className="mb-2">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold mb-2">Disclosure of Your Personal Data</h2>
